...
//Forgot password
String passwordSQL = "UPDATE customer SET password = ? WHERE userid = ? AND email = ? AND address = ?";
if (request.getParameter("password-submit") != null) {
    String email = request.getParameter("email");
    String username = request.getParameter("username");
    String address = request.getParameter("address");
    String password = request.getParameter("password");
    ...
    try {
        ...
        PreparedStatement pstmt = con.prepareStatement(passwordSQL);
...
<h1>Register User / Update User info/ Forgot password/</h1>
...
<!-- Forgot password -->
<form method="post" name="password-form">
    ...
    <input type="submit" name="password-submit" value="Update Password">
</form>
